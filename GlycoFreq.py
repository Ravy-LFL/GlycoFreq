"""Used to measure presence of carbohydrate on structure.
    ...
    Usage
    =====
        ./GlycoFreq.py -top <topology_file> -trj <trajectory_file> -output <file_name> -threshold <threshold_interaction> -skip <number_frame_to_skip>
"""
...
parser = argparse.ArgumentParser(prog = 'GlycoFreq', description = 'Compute frequence of interaction by carbohydrate on protein, and set it in new PDB structure as b-factor values.')
